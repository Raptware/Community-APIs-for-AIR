...
The _**Community-APIs-for-AIR**_ repository is an area where members of the community can post up their ANEs (AIR Native Extensions) to share with the rest of the world.  

This area is a collection of APIs that are not part of the official BlackBerry SDK for Adobe AIR but may prove as a testing ground for new APIs before they are potentially added to the SDK
...
The APIs in this repository are broken out into APIs for the BlackBerry PlayBook OS and for the BlackBerry 10 OS.  When adding your API to this repository you'll need to create your own sub-directory in the appropriate platform directory.

For specific information on how to organize your code in each of these sections, please refer to the README found in both the BlackBerry 10 and PlayBook directories.  They will have specific information on what pieces are needed to contribute an extension for each of the platforms.

## Contributing APIs

To add new APIs or make modifications to existing APIs:

1. Fork the **Community-APIs-for-AIR** repository
2. Make the changes/additions to your fork
3. Send a pull request from your fork back to the **Community-APIs-for-AIR** repository
...
* [Dustin Malik](https://github.com/dmalik)
